...
public class ArcherAttack : MonoBehaviour {
    ...
    private void Start() {
        ArcherProjetil = this.transform.parent.GetComponent<EnemyController>().ArcherProjetil;
    ...
    public void Attack() {
        ...
        if(this.transform.parent.GetComponent<EnemyController>().Enemy.isAlive) {
            if(this.transform.parent.GetComponent<EnemyController>().Enemy.ArcherAttack2) {
                //TripleAttack();
                ShadowArrow();
            } else {
                BasicAttack();
    ...
    private void InstantiateAttack() {
        ...
        if(ShadowAttackArrow) {
            ...
            this.transform.parent.GetComponent<EnemyController>().Enemy.ArcherAttack2 = false;
        }
