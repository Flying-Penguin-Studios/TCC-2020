...
public class EnemyController_Old : MonoBehaviour {
    ...
    private void DefineEnemy() {
        if(this.name.Contains("Soldier")) { Enemy = new Soldier_Old(); EnemyType = "Soldier"; Enemy.EnemyRangeType = "Melee"; }
        if(this.name.Contains("Guard")) { Enemy = new Guard_Odd(); EnemyType = "Guard"; Enemy.EnemyRangeType = "Melee"; }
        if(this.name.Contains("Archer")) { Enemy = new Archer_Old(); EnemyType = "Archer"; Enemy.EnemyRangeType = "Ranged"; }
        if(this.name.Contains("Zombie")) { Enemy = new Zombie_Old(); EnemyType = "Zombie"; Enemy.EnemyRangeType = "Melee"; }
    }
