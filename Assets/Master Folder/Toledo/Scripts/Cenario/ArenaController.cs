...
public class ArenaController : MonoBehaviour {
    ...
    IEnumerator ArenaenemyConfig(GameObject enemy) {        
        ...
        enemy.GetComponent<EnemyController>().SetRandomTarget();
        enemy.GetComponent<EnemyController>().RangedAttackDistance = 20f;
        enemy.GetComponent<EnemyController>().IsArenaEnemy = true;
