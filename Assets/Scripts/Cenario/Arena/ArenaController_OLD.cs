...
public class ArenaController_OLD : MonoBehaviour {
    ...
    //    if((other.gameObject == GameController_OLD.Singleton.ScenePlayer1)) {
    //        P1Inside = true;
    //    }

    //    if((other.gameObject == GameController_OLD.Singleton.ScenePlayer2)) {
    //        P2Inside = true;
    //    }
    //}
    ...
    //    if(!GameController_OLD.Singleton.ScenePlayer1.GetComponent<PlayerController>().ToVivo) { P1Inside = true; }
    //    if(!GameController_OLD.Singleton.ScenePlayer2.GetComponent<PlayerController>().ToVivo) { P2Inside = true; }
    ...
    //    if(ArenaStart && GameController_OLD.Singleton.ArenaEnemyCount == 0) {
    ...
    //    GameController_OLD.Singleton.ArenaEnemyCount = 28;
